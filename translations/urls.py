...
superuser_required = user_passes_test(lambda u: u.is_superuser, login_url="/translations/access-denied/")

urlpatterns = patterns('',
    url(r'^home/$', views.home, name='home'),
    url(r'^submit-new-article/$', views.submit_new_article, name='submit-new-article'),
    url(r'^new-article/$', views.new_article, name='new-article'),
    url(r'^articles/$', superuser_required(views.ArticleListView.as_view()), name='article_list'),
